...
public class SqlQueries {
	...
	public static final String SQL_GETEXERCISE = "SELECT EXERCISE_NAME, EXERCISE_START, EXERCISE_END, SCORING_POLICY_ID, NUM_OF_QUESTIONS, EXERCISE_MODE, RETRIES_ALLOWED, INCORRECT_ANSWER_PENALTY, CORRECT_ANSWER_POINTS FROM EXERCISE WHERE (COURSE_ID=? AND EXERCISE_ID=?)";
	...
	public static final String SQL_NOOFATTEMPT = "SELECT MAX(ATTEMPT) AS N_ATTEMPT FROM SUBMITS WHERE (COURSE_ID=? AND EXERCISE_ID=? AND USER_ID=?)";
	...
	public static final String SQL_GETPARAMETERID = "SELECT PARAMETER_ID FROM PARAMETER_ANSWER WHERE (QUESTION_ID=1? AND PARAMETER_ANSWER_ID=2?)";
	
	public static final String SQL_GETSTUDENTAPERCOURSE= "SELECT COUNT(*) FROM SUBMITS WHERE (COURSE_ID=? AND EXERCISE_ID=? AND USER_ID=?)";
