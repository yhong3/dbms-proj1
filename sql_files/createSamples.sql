...
Insert into EXERCISE (EXERCISE_ID,COURSE_ID,EXERCISE_NAME,EXERCISE_START,EXERCISE_END,RETRIES_ALLOWED,NUM_OF_QUESTIONS,SCORING_POLICY_ID,CORRECT_ANSWER_POINTS,INCORRECT_ANSWER_PENALTY,DIFFICULTY_LEVEL_MIN,DIFFICULTY_LEVEL_MAX,EXERCISE_MODE) values (3,'CSC540','Homework 3 for CSC540',to_date('12-OCT-17','DD-MON-RR'),to_date('30-NOV-17','DD-MON-RR'),1,3,3,4,1,3,5,0);
Insert into EXERCISE (EXERCISE_ID,COURSE_ID,EXERCISE_NAME,EXERCISE_START,EXERCISE_END,RETRIES_ALLOWED,NUM_OF_QUESTIONS,SCORING_POLICY_ID,CORRECT_ANSWER_POINTS,INCORRECT_ANSWER_PENALTY,DIFFICULTY_LEVEL_MIN,DIFFICULTY_LEVEL_MAX,EXERCISE_MODE) values (4,'CSC440','Homework 1 for CSC440',to_date('12-AUG-17','DD-MON-RR'),to_date('19-SEP-17','DD-MON-RR'),2,3,1,3,0,1,3,0);
