...
Insert into SUBMITS (USER_ID,COURSE_ID,EXERCISE_ID,QUESTION_ID,PARAMETER_ID,CONCRETE_ANSWER_ID,PARAMETER_ANSWER_ID,ATTEMPT,SUBMIT_TIME) values ('tregan','CSC440',1,1,null,4,null,1,to_date('27-AUG-17','DD-MON-RR'));
Insert into SUBMITS (USER_ID,COURSE_ID,EXERCISE_ID,QUESTION_ID,PARAMETER_ID,CONCRETE_ANSWER_ID,PARAMETER_ANSWER_ID,ATTEMPT,SUBMIT_TIME) values ('tregan','CSC440',1,2,null,6,null,1,to_date('27-AUG-17','DD-MON-RR'));
Insert into SUBMITS (USER_ID,COURSE_ID,EXERCISE_ID,QUESTION_ID,PARAMETER_ID,CONCRETE_ANSWER_ID,PARAMETER_ANSWER_ID,ATTEMPT,SUBMIT_TIME) values ('tregan','CSC440',1,3,1,null,2,1,to_date('27-AUG-17','DD-MON-RR'));
Insert into SUBMITS (USER_ID,COURSE_ID,EXERCISE_ID,QUESTION_ID,PARAMETER_ID,CONCRETE_ANSWER_ID,PARAMETER_ANSWER_ID,ATTEMPT,SUBMIT_TIME) values ('tregan','CSC440',1,1,null,7,null,2,to_date('29-AUG-17','DD-MON-RR'));
Insert into SUBMITS (USER_ID,COURSE_ID,EXERCISE_ID,QUESTION_ID,PARAMETER_ID,CONCRETE_ANSWER_ID,PARAMETER_ANSWER_ID,ATTEMPT,SUBMIT_TIME) values ('tregan','CSC440',1,2,null,9,null,2,to_date('29-AUG-17','DD-MON-RR'));
Insert into SUBMITS (USER_ID,COURSE_ID,EXERCISE_ID,QUESTION_ID,PARAMETER_ID,CONCRETE_ANSWER_ID,PARAMETER_ANSWER_ID,ATTEMPT,SUBMIT_TIME) values ('tregan','CSC440',1,3,2,null,6,2,to_date('29-AUG-17','DD-MON-RR'));
