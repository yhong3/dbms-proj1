...
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (11,3,'Question 11?',1,1,'Hint text Q11','detailed Explanation Q11');
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (12,3,'Question 12?',1,2,'Hint text Q12','detailed Explanation Q12');
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (13,3,'Question 13?',1,3,'Hint text Q13','detailed Explanation Q13');
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (14,3,'Question 14?',1,4,'Hint text Q14','detailed Explanation Q14');
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (15,3,'Question 15?',1,5,'Hint text Q15','detailed Explanation Q15');

Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (16,3,'Question 16?',1,1,'Hint text Q16','detailed Explanation Q16');
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (17,3,'Question 17?',1,2,'Hint text Q17','detailed Explanation Q17');
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (18,3,'Question 18?',1,3,'Hint text Q18','detailed Explanation Q18');
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (19,3,'Question 19?',1,4,'Hint text Q19','detailed Explanation Q19');
Insert into QUESTION (QUESTION_ID,TOPIC_ID,QUESTION_TEXT,TYPE,DIFFICULTY_LEVEL,HINT,DETAILED_EXPLANATION) values (20,3,'Question 20?',1,5,'Hint text Q20','detailed Explanation Q20');
